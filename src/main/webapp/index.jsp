                ...
                <form action="${pageContext.request.contextPath}/FirstStep" method="post">
                    <div class="margin-x-1">
                        ...
                        <div class="slider-container">
                            ...
                            <input class="input1 w-8" type="number" id="sliderValue" max="600000" min="5000" step="1000"
                                   value="5000" name="amount">
                            <input type="range" min="5000" max="600000" step="1000" value="5000" class="slider"
                                   id="mySlider">
                            <p class="label m-t-5">Durée (en mois)</p>
                            <input class="input1 w-5" name="durationsInMonths" type="number" id="durationValue" min="12"
                            ...
                            <input class="input1 w-9" name="monthlyPayment" type="number" id="mensualiteValue" min="1"
                                   max="80000" value="70">
                            <input type="range" min="1" max="80000" step="100" value="70" class="slider"
                                   id="mensualiteSlider">


                            <input type="hidden" name="durationsInMonths" id="durationsInMonths" value="0">
