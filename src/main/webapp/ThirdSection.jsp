        ...
        <div class="flex">
            <div class="card w-75 m-b-6">
                ...
                <div class="margin-x-1">
                    <form action="${pageContext.request.contextPath}/ThirdStep
" method="post">
                        ...
                        <div class="m-t-9 input-container">
                            ...
                            <label for="cin" class="custom-label">CIN*</label>
                        </div>
                        <div class="m-t-9 input-container">
                            <input type="date" name="birthdate" id="birthdate" placeholder="" class="custom-input" value="">
                            <label for="birthdate" class="custom-label">Date de naissance*</label>
                        </div>
                        <div class="m-t-9 input-container">
                            <input type="date" name="startEmployementDate" id="startEmployementDate" placeholder="" class="custom-input" value="">
                            <label for="startEmployementDate" class="custom-label">Date de début d'emploi*</label>
                        </div>
                        <div class="m-t-9 input-container">
                            <input type="text" name="monthlyIncome" id="monthlyIncome" placeholder="" class="custom-input" value="">
                            <label for="monthlyIncome" class="custom-label">Total revenus mensuels*</label>
                        </div>
